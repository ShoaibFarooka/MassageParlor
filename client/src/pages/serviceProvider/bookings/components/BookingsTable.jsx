            ...
            <table className="min-w-full">
                <thead>
                    <tr className="bg-[#E8E9EE] h-[64px]">
                        ...
                        <th className="text-sm font-bold text-center md:whitespace-nowrap whitespace-normal">Service</th>
                ...
                <tbody>
                    {bookings.map((booking) => (
                        <tr key={booking._id} className="border-b border-[#E8E9EE] h-[79.96px] last:border-none bg-white">
                            ...
                            <td className="text-center text-[12px]">{booking?.service_id?.name}</td>
